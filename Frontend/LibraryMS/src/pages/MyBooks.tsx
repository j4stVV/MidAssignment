...
import { getAllBorrowingRequests, getUserBorrowingRequests } from '@/services/BorrowingService';
...
const MyBooks = () => {
  ...
  const loadRequests = async () => {
    setIsLoading(true);
    try {
      const allRequests = await getUserBorrowingRequests();
      console.log('API Requests:', allRequests);
